...
public class ProductController {// Contoller ile products'ı 3 ana başlık altına bölündü. Hibernate, JdbcTemplate ve Jdbc, kendi mapping'leriyle aynı işlemleri yapmak adına düzenlendi.
	...
	@PostMapping(value = "/hibernate/dummy")
	public void hibernateDummys() {// Hibernate değerinin ilk önce atanması tüm DAO'ların çalışmasında önemli olduğu için ilk bu endpoint çalıştırılmalı.
		productService.sendHibernateValue();
	}

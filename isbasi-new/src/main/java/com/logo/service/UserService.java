...
public class UserService {
	...
	public User createUser(User user) {
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", user.getName()+", Java",
				user.getEmail()));
	...
	public void sendInitialEmailValues() {// Hazırdan email değerlerini queue'a göndermek için tasarlandı.
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", "Ahmet"+", Java",
				"Ahmet@gmail.com"));
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", "Mehmet"+", Java",
				"Mehmet@gmail.com"));
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", "John"+", Java",
				"John@gmail.com"));
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", "Mary"+", Java",
				"Mary@gmail.com"));
		rabbitTemplate.convertAndSend("isbasi.email", new EmailDto("Patika dev", "Martin"+", Java",
				"Martin@gmail.com"));
	}
